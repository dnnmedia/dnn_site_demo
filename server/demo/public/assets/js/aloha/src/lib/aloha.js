...
(function (global) {
	...
	function load() {
		...
		var alohaRequire = requirejs.config(requireConfig);
		...
		requirejs(requireConfig, ['aloha', 'aloha/jquery'], function (Aloha, $) {
			requirejs(requireConfig, pluginConfig.entryPoints, function () {
				$(function () {
